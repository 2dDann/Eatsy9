package com.example.eatsy9.adapters;
...
import com.example.eatsy9.R;
import com.example.eatsy9.YogurtDetailsActivity;
import com.example.eatsy9.models.MenuVerModel;
import com.example.eatsy9.MenuActivity;
...
public class MenuVerAdapter extends RecyclerView.Adapter<MenuVerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // The save icon based on the save state
        if (isSaved) {
            holder.iv_save_icon.setImageResource(R.drawable.saved_icon);
        } else {
            holder.iv_save_icon.setImageResource(R.drawable.save_icon);
        }

        // Click listener for the save icon
        holder.iv_save_icon.setOnClickListener(new View.OnClickListener() {
            @Override
